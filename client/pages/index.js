				...
				<div class="container px-5 py-24 mx-auto">
					...
					<div class="p-4 lg:w-1/4 md:w-1/2">
						...
						<div class="w-full">
							...
							<p class="mb-4">Read "Smart Contracts for Dummies" and decided to develop his own bleeding-edge tools.</p>
					...
					<div class="p-4 lg:w-1/4 md:w-1/2">
						<div class="h-full flex flex-col items-center text-center">
						<img alt="team" class="flex-shrink-0 rounded-lg w-full h-128 object-cover object-center mb-4" src="/syn.png" />
						<div class="w-full">
							<h2 class="title-font font-medium text-lg text-gray-900">Syn</h2>
